...
The Narnoor font has been tested to work on Microsoft Word, Notepad, LibreOffice, Adobe InDesign, Chrome, Firefox, and Microsoft Edge. There may be some settings which must be modified in order for the font to work. For example, in Microsoft Word, go to the *Font / Advanced* menu and select *Ligatures / All*. In Adobe InDesign, select *Paragraph / Adobe World-Ready Paragraph Composer*.

Narnoor is designed to work with OpenType advanced font technologies. To take advantage of the advanced typographic capabilities of this font, you must be using applications that provide an adequate level of support for OpenType. In particular, Affinity Publisher probably does not have the needed OpenType support.
